...
const faqs = [
  ...
  },
  {
    ...
    answer: "Sim! Temos horários flexíveis, incluindo sábados, para atender quem trabalha ou estuda durante a semana. Entre em contato para verificar disponibilidade e agendar seus horários."
  }
];
